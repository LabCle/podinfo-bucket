# Podinfo - Podinfo-bucket

[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/LabCle/podinfo-bucket)
...
humctl config set app podinfo-bucket
